...
<body>
  ...
  <nav class="navbar navbar-expand-lg shadow-sm px-5 py-0">
    <div class="container-fluid">
      <!-- Logo -->
      <a class="navbar-brand text-primary fs-4 fw-bold d-flex align-items-center" href="{{ route('admin.user') }}">
      ...
      <div class="ms-auto d-flex align-items-center gap-3">
        ...
        <a href="{{ route('admin.notification') }}" class="text-decoration-none text-primary position-relative">
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="white" class="bi bi-bell" viewBox="0 0 16 16">
        ...
        <div class="dropdown">
          <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#fff" class="bi bi-person-circle me-2" viewBox="0 0 16 16">
              <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
              <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
            </svg>
            <span class="me-2 fs-5 fw-semibold" style="color: #fff;">
              {{ Auth::user()->fullname }}
            </span>
          </a>
  ...
  <div class="d-flex pt-3 px-2">
    ...
    <div class="sidebar-custom d-flex flex-column">
      <h4 class="text-center py-3 border-bottom border-light">Menu</h4>
      <ul class="nav flex-column px-3">
        ...
        <li class="nav-item">
          <a class="nav-link fs-5 {{ request()->routeIs('admin.notification') ? 'active' : '' }}" href="{{ route('admin.notification') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16"><path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2M8 1.918l-.797.161A4 4 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4 4 0 0 0-3.203-3.92zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5 5 0 0 1 13 6c0 .88.32 4.2 1.22 6"/></svg>
            Notification
          </a>
        </li>
      </ul>
    ...
    <!-- Nội dung chính -->
    <div class="flex-grow-1 p-4" style="margin-top: 90px; margin-left: 200px;">
      @yield('content')
    </div>
